...
*/
   ...
   var Ka = function (a) {
         ...
         za(
            "expected object of type SafeUrl, got '" + a + "' of type " + ia(a)
         );
...
*/
         ...
         if ((b = ab(bb(), "safevalues").pa)) {
            ...
            if (a) {
               ...
               if (0 < e.C) {
                  ...
                  e.Z = f;
                  e.ba
                     ? ((e = e.X[f]), e.reset(d, c, b), (b = e))
                     : ((e.ba = f == e.C - 1), (b = e.X[f] = new Va(d, c, b)));
               } else b = new Va(d, c, b);
               Ya(a, b);
            }
         }
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
         ...
         if (Nb()) a();
            ...
            y.addEventListener
               ? (y.addEventListener("load", c, !1),
                 y.addEventListener("DOMContentLoaded", c, !1))
               : y.attachEvent &&
         ...
         try {
            ...
            if (e && 0 < e.length) {
               ...
               for (d = {}; c < e.length; ) {
                  ...
                  f = u(l)
                     ? "o" +
                       ((Object.prototype.hasOwnProperty.call(l, ma) &&
                          l[ma]) ||
                          (l[ma] = ++na))
                     : (typeof l).charAt(0) + l;
   ...
   var $c,
      ...
      Bd = function (a) {
         if (-1 !== V)
            return zd(), W ? t.JSON.stringify.call(t.JSON, a) : gd(a);
      },
      Cd =
      ...
      Dd = function () {
         ...
         return [
            ...
            ".",
            String(1e3 + Date.prototype.getUTCMilliseconds.call(this)).substr(
               1
            ),
            "Z",
         ].join("");
   ...
   Fd.prototype.update = function (a, b) {
      if (null != a) {
         void 0 === b && (b = a.length);
         for (
            var c = b - this.blockSize, d = 0, e = this.M, f = this.v;
            d < b;
            ...
            if ("string" === typeof a)
               for (; d < b; ) {
                  if (
                     ((e[f] = a.charCodeAt(d)), ++f, ++d, f == this.blockSize)
                  ) {
                     Gd(this, e);
                     f = 0;
                     break;
   ...
   Fd.prototype.digest = function () {
      var a = [],
         b = 8 * this.K;
      56 > this.v
         ? this.update(this.J, 56 - this.v)
         : this.update(this.J, this.blockSize - (this.v - 56));
   ...
   var Vd = {
      ...
      Zd = function (a, b, c, d, e) {
         ...
         for (var h in c)
            (a = c[h]),
               "style" === h && "object" === typeof a
                  ? E(a, f.style)
                  : Wd[h] || f.setAttribute(h, String(a));
   ...
   var ze = function (a, b) {
      ...
      Ae = function (a, b, c, d) {
         ...
         for (f = 0; f < e.length; f++) {
            ...
            if (g.getAttribute("data-gapiscan")) k = null;
               ...
               0 == n
                  ? (l = h.substr(2))
                  : (n =
                       (n = String(g.className || g.getAttribute("class"))) &&
                       xe.exec(n)) && (l = n[1]);
               k =
                  !l || !(se[l] || te[l] || ue[l]) || (k && l !== k) ? null : l;
            }
            k &&
               (ye[k] ||
         ...
         if (Ce(we || {}))
            ...
            d = [];
            for (J in c)
               for (a = c[J], p = 0, b = a.length; p < b; p++)
                  (e = a[p]), Ee(J, e, oe(e), d, b);
            Fe(q, d);
         }
      },
      Ge = function (a) {
         ...
         switch (Ke(b, a, f)) {
            ...
            case 1:
               if (b.parentNode) {
                  ...
                  do
                     g =
                        f.id || ["I", Xd++, "_", new Date().getTime()].join("");
                  ...
                  !n &&
                     p &&
                     ((p =
                        I(b.location.href, "_gfid", "") ||
                        I(b.location.href, "id", "")),
   ...
   Te.prototype.read = function () {
      for (
         var a = this.P + "=", b = document.cookie.split(/;\s*/), c = 0;
         c < b.length;
         ++c
      ) {
         var d = b[c];
   ...
   function af(a) {
      ...
      d = "E" === c && e.l;
      return (!d && ("U" !== c || e.l)) || (d && !Xe)
         ? b
         : { ca: !0, l: d, va: a.substr(1), domain: e.domain, o: e.o };
   }
   var bf = function (a) {
         if (!a) return [];
         a = a.split("=");
   ...
   m.ea = function () {
      this.O &&
         (this.Y()
            ? (this.A = this.V)
            : (this.A = Math.min(2 * (this.A || this.V), 120)),
   ...
   window.gapi.load("", {
      ...
      _c: {
         ...
         jsl: {
            ...
            h: "m;/_/scs/abc-static/_/js/k=gapi.lb.ru.fvCSXqWR094.O/d=1/rs=AHpOoo88emHWCICPfjRpd9SuPuSKoIuM4Q/m=__features__",
